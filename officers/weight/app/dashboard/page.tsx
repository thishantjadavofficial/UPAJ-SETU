          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="bg-gray-50 px-6 py-4 border-b border-gray-200 flex justify-between items-center">
              <div>
                ...
                <p className="text-sm text-gray-600">{tokenData.farmer_name} â€¢ Arrived: {new Date(tokenData.arrived_at).toLocaleTimeString()}</p>
              </div>
                  ...
                  <table className="w-full text-left border-collapse">
                    <thead>
                      <tr className="border-b border-gray-200">
                        ...
                        <th className="pb-3 text-sm font-semibold text-gray-600">Rate (â‚¹)</th>
                    ...
                    <tbody>
                      {lots.map((lot) => (
                        <tr key={lot.id} className={`border-b border-gray-100 last:border-0 ${lot.status === 'WEIGHED' ? 'bg-green-50/50' : ''}`}>
                          ...
                          <td className="py-4">â‚¹{lot.auction_rate}</td>
                          <td className="py-4">
                            {lot.status === 'WEIGHED' ? (
